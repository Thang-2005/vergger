            ...
            <div class="col-lg-4  mb-120">
                <aside class="sidebar ltn__shop-sidebar">
                    ...
                    <div class="widget ltn__top-rated-product-widget">
                        <h4 class="ltn__widget-title ltn__widget-title-border">{{ 'Sản phẩm được xếp hạng cao' }}</h4>
                            ...
                            <li>
                                <div class="top-rated-product-item clearfix">
                                    <div class="top-rated-product-img">
                                        <a href="{{ route('product.detail', $products_favorite->slug) }}">
                                            <img src="{{ $products_favorite->image_url }}"
                                                alt="{{ $products_favorite->name }}">
                                    ...
                                    <div class="top-rated-product-info">
                                        ...
                                        <h6><a href="{{ route('product.detail', $products_favorite->id) }}">{{$products_favorite->name}}</a></h6>
