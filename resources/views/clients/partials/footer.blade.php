            ...
            <div class="footer-top-area  section-bg-2 plr--5">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                            <div class="footer-widget footer-about-widget">
                                <div class="footer-logo">
                                    <div class="site-logo">
                                        <img src="{{ asset('asset/client/img/logo-2.png') }}" alt="Logo">
                                    </div>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="footer-address-info">
                                                <p>Thien Dinh, Ha Noi, Viet Nam</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="footer-address-icon">
                                        ...
                                        <li>
                                            ...
                                            <div class="footer-address-info">
                                                <p><a href="mailto:nguyenthang2611205@gmail.com">nguyenthang2611205@gmail.com</a>
                                                </p>
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                            <div class="footer-widget footer-menu-widget clearfix">
                                <h4 class="footer-title">{{ __('messages.service') }}</h4>
                                <div class="footer-menu">
                                    <ul>
                        ...
                        <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                            <div class="footer-widget footer-newsletter-widget">
                                ...
                                <img src="{{ asset('asset/client/img/logo-2.png') }}" alt="Payment Image">
                            </div>
                        </div>
                    </div>
                </div>
