            ...
            <div class="x_panel">
                <div class="x_content">
                    <div style="display:flex; align-items:center; justify-content:space-between;">
                        <div>
                            <p style="margin:0 0 4px; color:#7a7a7a;">Tong danh muc</p>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="x_panel">
                <div class="x_content">
                    <div style="display:flex; align-items:center; justify-content:space-between;">
                        <div>
                            <p style="margin:0 0 4px; color:#7a7a7a;">Dang hoat dong</p>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="x_panel">
                <div class="x_content">
                    <div style="display:flex; align-items:center; justify-content:space-between;">
                        <div>
                            <p style="margin:0 0 4px; color:#7a7a7a;">Dang an</p>
                ...
                <div class="x_title d-flex align-items-center justify-content-between">
                    ...
                    @if($canCreateCategory)
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#createCategoryModal">
                            <i class="fa fa-plus"></i> Them danh muc
                        </button>
                    @endif
                </div>
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:90px;">Anh</th>
                                    <th>Ten danh muc</th>
                                    <th>Slug</th>
                                    <th>San pham</th>
                                    <th>Trang thai</th>
                                    <th style="width:280px;">Thao tac</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <div style="width:60px; height:60px; border-radius:10px; border:1px dashed #d9d9d9; display:flex; align-items:center; justify-content:center; color:#999; font-size:12px; text-align:center; padding:4px;">No image</div>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @if($category->status)
                                                <span class="label label-success">Hoat dong</span>
                                            @else
                                                <span class="label label-default">Da an</span>
                                            @endif
                                        </td>
                                        <td>
            ...
            <div class="modal-body">
                @if($canCreateCategory)
                    <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="slug">Slug (tu dong neu de trong)</label>
