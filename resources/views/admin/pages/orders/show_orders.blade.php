                    ...
                    <form method="GET" action="{{ route('admin.orders.list') }}" class="row" style="margin-bottom:18px;">
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="keyword" name="keyword" class="form-control" value="{{ request('keyword') }}" placeholder="{{ 'Tìm mã đơn, tên khách, số điện thoại...' }}">
                            </div>
                        </div>
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:180px;">{{ 'Xem chi tiết' }} {{ 'Đơn Hàng' }}</th>
